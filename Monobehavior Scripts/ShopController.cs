...
public class ShopController : MonoBehaviour
{
    ...
    {
        string filePath = "Assets/Scripts/items_data.txt"; // Path to the file
        string answer = "";
    ...
    {
        this.playerTMP.text = "Pellets: " + MySingleton.pellets + "(HP: " + MySingleton.thePlayer.getHP() + ")"; ;
    }
    ...
    void Update()
    {
        if (Input.GetKeyUp(KeyCode.Alpha1))
        {
            ...
            if (MySingleton.pellets >= ItemsSingleton.cherryItemCost)
            {
                MySingleton.pellets -= ItemsSingleton.cherryItemCost;
